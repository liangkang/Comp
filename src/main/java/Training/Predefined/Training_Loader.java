...
public class Training_Loader extends
		GraphLoader<Text, Training_VertexValue, Text, Text> {
	...
	public void load(
			...
			MutationContext<Text, Training_VertexValue,Text, Text> context)
			throws IOException {

		Training_Vertex vertex = new Training_Vertex();
